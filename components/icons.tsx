...
interface IconProps extends React.SVGProps<SVGSVGElement> {
  name: 'paperclip' | 'send' | 'image' | 'calendar' | 'edit' | 'trash' | 'user' | 'bot' | 'x' | 'settings' | 'algorithmx' | 'facebook' | 'shield-check';
}
    ...
    case 'algorithmx':
      return (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
          <path d="M6 18L13 11" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
          <path d="M12 6L18 12L12 18" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      );
    case 'paperclip':
      return (
